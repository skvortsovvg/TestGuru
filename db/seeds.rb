...
#Пользователи
Users.create([ {name: Vladimir}, {name: Dmitry}, {name: Alexander} ])

#ТЕСТЫ Backend
category = Category.create(title: "Backend")

new_test = Test.create(title: "Ruby", level: 2, category_id: category.id, author_id: users.first.id)
...
new_test = Test.create(title: "HTML", level: 1, category_id: category.id, author_id: users.first.id)
...
new_test = Test.create(title: "JavaScript", level: 2, category_id: category.id, author_id: users.first.id)
