...
answer = Answer.create(body: "some = nil", correct: true, question_id: question.id)
Answer.create(body: "some = """, question_id: question.id)
Answer.create(body: "some = 0", question_id: question.id)
Answer.create(body: "some", question_id: question.id)

Result.create(user_id: User.first.id, test_id: new_test.id, question_id: question.id, answer_id: answer.id)
...
answer = Answer.create(body: "num = gets.to_i", question_id: question.id)
...
answer = Answer.create(body: "Ruby On Rails", correct: true, question_id: question.id)

Result.create(user_id: User.first.id, test_id: new_test.id, question_id: question.id, answer_id: answer.id)

question = Question.create(body: "Где записана сокращенная форма кода: x = x / 3", test_id: new_test.id)
answer = Answer.create(body: "x = / 3", question_id: question.id)
...
answer = Answer.create(body: "downcase()", correct: true, question_id: question.id)
...
answer = Answer.create(body: "<br>", correct: true, question_id: question.id)
...
answer = Answer.create(body: "name", question_id: question.id)
...
answer = Answer.create(body: "Глобальные можно переопределять, локальные нельзя", correct: true, question_id: question.id)
...
Result.create(user_id: User.last.id, test_id: new_test.id, question_id: question.id, answer_id: answer.id)
