...
const DEFAULT_ITEM_ID = '#imagename' 
...
class ChiefSlider {
  constructor(selector, config) {
    ...
    this._$defaultItem = $root.querySelector(DEFAULT_ITEM_ID);
    this._defaultItemID = 0;
    ...
    for (let i = 0, length = $itemList.length; i < length; i++) {
      ...
      if ($itemList[i].dataset.imagename === this._$defaultItem.value) {
        this._defaultItemID = i;
      }
    ...
    this._moveTo(this._defaultItemID);
  ...
  _setActiveClass() {
    ...
    for (let i = 0, length = $itemList.length; i < length; i++) {
      ...
      if (activeItems.indexOf(index) > -1) {
        ...
        this._$defaultItem.value = $item.dataset.imagename
      } else {
